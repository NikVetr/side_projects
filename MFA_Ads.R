...
#try out the dirichlet thing
m1cc.a <- map2stan(
  alist(
    c(X2DaysPork, X2DaysBeef, X2DaysBird, X2DaysSea) ~ dcategorical(servings, probs),
    probs ~ ddirichlet(c(concP, concC, concB, concS)),
    servings ~ dzipois( p , lambda ),
    logit(p) <- pI + pT*Treat,
